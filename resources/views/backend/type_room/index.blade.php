...
<div class="card shadow-sm mb-4" style="background-color: #f8f9fa;">
    ...
    <div class="card-header py-3 d-flex flex-column flex-md-row justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size: 1.25rem;">Type Room List</h6>
        <a href="{{ route('backend.type_room.create') }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Add Type Room">
            ...
            <table class="table table-striped table-hover table-bordered" id="post-category-dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <form method="POST" action="{{ route('backend.type_room.destroy', $type->id) }}" class="d-inline delete-form">
                            @csrf
                            @method('delete')
