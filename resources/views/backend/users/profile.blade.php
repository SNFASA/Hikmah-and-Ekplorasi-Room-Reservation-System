        ...
        <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-center">
            ...
            <div class="header-actions mt-3 mt-lg-0">
                <nav class="modern-breadcrumb">
                    <a href="{{ route('admin') }}" class="breadcrumb-item"><!--tukar-->
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-8">
                    <div class="form-section">
                        ...
                        <form method="POST" action="{{ route('admin-profile-update', $profile->id) }}" class="modern-form"><!--tukar-->
                            @csrf
                            ...
                            <div class="form-actions">
                                ...
                                <a href="{{ route('admin') }}" class="btn btn-cancel"><!--tukar-->
