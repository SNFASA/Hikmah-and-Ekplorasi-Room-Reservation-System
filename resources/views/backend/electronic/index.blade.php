...
<div class="card shadow-sm mb-4" style="background-color: #f8f9fa;">
    ...
    <div class="card-header py-3 d-flex flex-column flex-md-row justify-content-between align-items-center">
        ...
        <a href="{{ route('electronic.create') }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Add Electronic">
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class="table table-striped table-hover table-bordered" id="electronic-dataTable" width="100%" cellspacing="0">
...
$(document).ready(function() {
    $('#electronic-dataTable').DataTable({
        paging: false,
        ordering: true,
        columnDefs: [{
            orderable: false,
