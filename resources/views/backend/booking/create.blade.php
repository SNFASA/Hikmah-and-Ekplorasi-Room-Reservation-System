        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Create a new room booking with student details</p>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 mt-1 opacity-75">
                                Set up booking details, schedule, and student information
                            </p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('bookings.store') }}" id="booking-form">
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Enter the basic details for the booking</p>
                            </div>
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Set the date and time for the booking</p>
                            </div>
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Add students to this booking (minimum 4 required)</p>
                            </div>
                            ...
                            <div class="card border-0 bg-white shadow-sm rounded-3">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h6 class="fw-bold text-dark mb-0">
                                            ...
                                            <span class="badge selected-count rounded-pill ms-2">
                                                <span id="studentCount">1</span> / 10 students
                                            </span>
                                        </h6>
                                    ...
                                    <div class="alert alert-info rounded-3 mb-0">
                                        ...
                                        <strong>Note:</strong> You must add at least 4 students to proceed with the booking. Maximum 10 students allowed.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        <div class="form-summary">
                                            <h6 class="mb-1 fw-bold text-dark">Ready to Create Booking?</h6>
                                            <p class="mb-0 text-muted small">Review your booking details before creating</p>
                                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <div class="fw-semibold text-white">Time Selection</div>
...
$(document).ready(function() {
    console.log('Booking Create Form initializing...');
    ...
    function validateForm() {
        ...
        if (studentCount < 4) {
            errors.push('You must add at least 4 students before submitting the form');
            isValid = false;
        }
    ...
    console.log('Booking Create Form initialized successfully');
});
</script>
@endpush