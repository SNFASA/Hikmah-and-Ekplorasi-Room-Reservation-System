    ...
    <div class="header-section mb-4">
        ...
        <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-center">
            ...
            <div class="header-actions mt-3 mt-lg-0">
                <a href="{{ route('furniture.create') }}" class="btn btn-create">
                                    ...
                                    <tr class="table-row" data-id="{{$item->no_furniture}}">
                                        ...
                                        <td class="action-cell">
                                            <div class="action-buttons">
                                                <a href="{{ route('furniture.edit', $item->no_furniture) }}"
                                                ...
                                                <form method="POST" action="{{ route('furniture.destroy', $item->no_furniture) }}" class="d-inline">
                                                    @csrf 
                                                    @method('delete')
                                                    <button type="button"
