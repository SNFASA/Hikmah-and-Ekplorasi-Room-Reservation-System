        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Create new department for room assignment</p>
                </div>
        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card electronic-card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 mt-1 opacity-75">
                                Set up Department details and specifications
                            </p>
                        </div>
                ...
                <div class="card-body bg-light p-4">
                    <form method="POST" action="{{ route('backend.department.store') }}" id="electronicCreateForm">
                        @csrf
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Enter the basic details for the department  </p>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        <div class="form-summary">
                                            <h6 class="mb-1 fw-bold text-dark">Ready to Create department ?</h6>
                                            <p class="mb-0 text-muted small">Review your department configuration before creating</p>
                                        </div>
