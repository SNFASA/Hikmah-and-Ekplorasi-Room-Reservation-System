    ...
    <div class="header-section mb-4">
        ...
        <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-center">
            <div class="header-title">
                ...
                <p class="subtitle">Manage department and their configurations</p>
            </div>
            <div class="header-actions mt-3 mt-lg-0">
                <a href="{{ route('backend.department.create') }}" class="btn btn-create">
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table modern-table" id="electronicTable">
                            ...
                            <tbody>
                                @foreach($dpt as $dpts)
                                    <tr class="table-row" data-id="{{ $dpts->no_department }}">
                                        <td class="id-cell">
                                        ...
                                        <td class="device-cell">
                                            <div class="device-info">
                                                ...
                                                <span class="device-name">{{ $dpts->name }}</span>
                                            </div>
                                        </td>
                                        <td class="action-cell">
                                            <div class="action-buttons">
                                                <a href="{{ route('backend.department.edit', $dpts->no_department) }}"
                                                ...
                                                <form method="POST" action="{{ route('backend.department.destroy', $dpts->no_department) }}" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button"
                                                            class="action-btn delete-btn dltBtn"
                                                            data-id="{{ $dpts->no_department }}"
                                                            data-bs-toggle="tooltip"
                                                            data-bs-placement="top"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="pagination-info">
                                Showing {{$dpt->firstItem()}} to {{$dpt->lastItem()}}
                                of {{$dpt->total()}} results
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="pagination-wrapper">
                                {{ $dpt->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
            @else
                ...
                <div class="empty-state">
                    <div class="empty-state-content">
                        ...
                        <h3 class="empty-title">No department Found</h3>
                        <p class="empty-description">
                            Get started by adding your first department.
                            You can add  department information.
                        </p>
                        <a href="{{ route('backend.department.create') }}" class="btn btn-create">
                            <i class="fas fa-plus me-2"></i>
                            Add department
...
$(document).ready(function() {
    ...
    $('.dltBtn').click(function(e) {
        ...
        swal({
            title: "Delete department ?",
            text: "This action cannot be undone. The department and all its data will be permanently deleted.",
            icon: "warning",
            buttons: {
                cancel: {
                    text: "Cancel",
