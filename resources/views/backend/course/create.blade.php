        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Create new Course for room assignment</p>
                </div>
        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card electronic-card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 mt-1 opacity-75">
                                Set up Course details and specifications
                            </p>
                        </div>
                ...
                <div class="card-body bg-light p-4">
                    <form method="POST" action="{{ route('backend.course.store') }}" id="electronicCreateForm">
                        @csrf
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Enter the basic details for the Course  </p>
                            </div>
                                        ...
                                        <select name="department_id" class="form-control form-control-modern @error('department_id') is-invalid @enderror" required>
                                            ...
                                            @foreach($dpt as $dpts)
                                                <option value="{{ $dpts->no_department }}"
                                                    @if(old('department_id') == $dpts->no_department) selected @endif>
                                                    {{ $dpts->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        <div class="form-summary">
                                            <h6 class="mb-1 fw-bold text-dark">Ready to Create Course ?</h6>
                                            <p class="mb-0 text-muted small">Review your Course configuration before creating</p>
                                        </div>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('backend.course.index') }}"
...
$(document).ready(function() {
    console.log('Department Create Form initializing...');
        let progress = 0;
    ...
    console.log('Type department Form initialized successfully');
});
</script>
@endpush
