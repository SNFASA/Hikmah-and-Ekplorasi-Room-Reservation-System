    ...
    <div class="header-section mb-4">
        ...
        <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-center">
            <div class="header-title">
                ...
                <p class="subtitle">Manage Course and their configurations</p>
            </div>
            <div class="header-actions mt-3 mt-lg-0">
                <a href="{{ route('backend.course.create') }}" class="btn btn-create">
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table modern-table" id="electronicTable">
                            ...
                            <tbody>
                                @foreach($crs as $crss)
                                    <tr class="table-row" data-id="{{ $crss->no_course }}">
                                        <td class="id-cell">
                                        ...
                                        <td class="device-cell">
                                            <div class="device-info">
                                                ...
                                                <span class="device-name">{{ $crss->name }}</span>
                                            </div>
                                        </td>
                                        <td class="device-cell">
                                            <div class="device-info">
                                                ...
                                                <span class="device-name">
                                                    {{$crss->department?->name ?? 'N/A'}}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="action-cell">
                                            <div class="action-buttons">
                                                <a href="{{ route('backend.course.edit', $crss->no_course) }}"
                                                ...
                                                <form method="POST" action="{{ route('backend.course.destroy', $crss->no_course) }}" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button"
                                                            class="action-btn delete-btn dltBtn"
                                                            data-id="{{ $crss->no_course }}"
                                                            data-bs-toggle="tooltip"
                                                            data-bs-placement="top"
                                                            title="Delete Course">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="pagination-info">
                                Showing {{$crs->firstItem()}} to {{$crs->lastItem()}}
                                of {{$crs->total()}} results
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="pagination-wrapper">
                                {{ $crs->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
            @else
                ...
                <div class="empty-state">
                    <div class="empty-state-content">
                        ...
                        <h3 class="empty-title">No Course Found</h3>
                        <p class="empty-description">
                            Get started by adding your first Course.
                            You can add  Course information.
                        </p>
                        <a href="{{ route('backend.course.create') }}" class="btn btn-create">
                            <i class="fas fa-plus me-2"></i>
                            Add Course
...
$(document).ready(function() {
    ...
    $('.dltBtn').click(function(e) {
        ...
        swal({
            title: "Delete Course ?",
            text: "This action cannot be undone. The Course and all its data will be permanently deleted.",
            icon: "warning",
            buttons: {
                cancel: {
                    text: "Cancel",
