        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Update Courses details and specifications</p>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 mt-1 opacity-75">
                                Update Courses and specifications
                            </p>
                        </div>
                        <div class="col-md-4 text-md-end">
                            <div class="creation-info">
                                <small class="d-block opacity-75">Courses id:</small>
                                <strong>{{ $crs->no_course }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('backend.course.update', $crs->no_course) }}" id="electronicEditForm">
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Update the details for this Courses</p>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value text-muted">
                                                    {{ $crs->department ? $crs->department->name : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        <div class="form-summary">
                                            <h6 class="mb-1 fw-bold text-dark">Ready to Update Courses?</h6>
                                            <p class="mb-0 text-muted small">Review your changes before updating the Courses</p>
                                        </div>
...
$(document).ready(function() {
    console.log('Courses Edit Form initializing...');
