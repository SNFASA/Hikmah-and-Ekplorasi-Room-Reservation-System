        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Update Category details and specifications</p>
                </div>
        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card electronic-card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 mt-1 opacity-75">
                                Update Category and specifications
                            </p>
                        </div>
                        <div class="col-md-4 text-md-end">
                            <div class="creation-info">
                                <small class="d-block opacity-75">Category ID:</small>
                ...
                <div class="card-body bg-light p-4">
                    <form method="POST" action="{{ route('backend.category.update', $categories->id) }}" id="electronicEditForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Update the details for this Category</p>
                            </div>
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Review current Category information</p>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value text-muted">{{ $categories->name }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        <div class="form-summary">
                                            <h6 class="mb-1 fw-bold text-dark">Ready to Update Category?</h6>
                                            <p class="mb-0 text-muted small">Review your changes before updating the category</p>
                                        </div>
