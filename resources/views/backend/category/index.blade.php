    ...
    <div class="header-section mb-4">
        ...
        <div class="header-content d-flex flex-column flex-lg-row justify-content-between align-items-center">
            <div class="header-title">
                ...
                <p class="subtitle">Manage all Category and their configurations</p>
            </div>
            <div class="header-actions mt-3 mt-lg-0">
                <a href="{{ route('backend.category.create') }}" class="btn btn-create">
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <div class="stats-info">
                                <span class="badge badge-info">
                                    <i class="fas fas fa-tags me-1"></i>
                                    ...
                                    <tr class="table-row" data-id="{{$item->id}}">
                                        ...
                                        <td class="action-cell">
                                            <div class="action-buttons">
                                                ...
                                                <form method="POST" action="{{ route('backend.category.destroy', $item->id) }}" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button"
                ...
                <div class="empty-state">
                    <div class="empty-state-content">
                        ...
                        <p class="empty-description">
                            ...
                            You can add  categories information.
                        </p>
                        <a href="{{ route('backend.category.create') }}" class="btn btn-create">
                            <i class="fas fa-plus me-2"></i>
                            Add Category
...
$(document).ready(function() {
    ...
    $('.dltBtn').click(function(e) {
        ...
        swal({
            ...
            text: "This action cannot be undone. The Category and all its data will be permanently deleted.",
            icon: "warning",
            buttons: {
                cancel: {
                    text: "Cancel",
