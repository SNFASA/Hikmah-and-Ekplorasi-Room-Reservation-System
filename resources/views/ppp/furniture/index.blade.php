...
<div class="card shadow-sm mb-4" style="background-color: #f8f9fa;">
    ...
    <div class="card-header py-3 d-flex flex-column flex-md-row justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size: 1.25rem;">Furniture List</h6>
        <a href="{{route('ppp.furniture.create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Add Furniture">
    ...
    <div class="card-body">
        <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('ppp.furniture.edit',$data->no_furniture)}}" 
                               class="btn btn-primary btn-sm rounded-circle mr-1 action-btn-edit" 
                               style="height:34px; width:34px;" 
                               data-toggle="tooltip" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{route('ppp.furniture.destroy',[$data->no_furniture])}}" class="d-inline">
                                @csrf 
                                @method('delete')
                                <button class="btn btn-danger btn-sm rounded-circle dltBtn action-btn-delete" 
                                        data-id={{$data->no_furniture}}
                                        style="height:34px; width:34px;" 
            ...
            @else
                <h6 class="text-center text-muted">No furniture found! Please create one.</h6>
            @endif
        </div>
    </div>
</div>
