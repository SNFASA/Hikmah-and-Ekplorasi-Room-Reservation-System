    ...
    <div class="card-body">
        <form method="post" action="{{ route('ppp.maintenance.update', $maintenances->id) }}">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="reported_by" name="reported_by" value="{{ $reported_by }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="inputTitle" name="title" value="{{ $maintenances->title }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="description" name="description" rows="3" 
                          class="form-control bg-white border rounded px-3 py-2" readonly>{{ $maintenances->description }}</textarea>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="flatpickrDate" name="date_maintenance" value="{{ $maintenances->date_maintenance }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="itemType" name="itemType" value="{{ $maintenances->itemType }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="itemid" name="itemid" value="{{ $itemName }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="room_id" name="room_id" value="{{ $rooms->name ?? '' }}" 
                       class="form-control bg-white border rounded px-3 py-2" readonly>
