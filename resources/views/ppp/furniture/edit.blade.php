...
<div class="card shadow-sm border-0 mt-4">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('ppp.furniture.update', $furniture->no_furniture) }}">
            @csrf 
            @method('PUT')
            ...
            <div class="form-group mb-3 d-flex flex-column flex-sm-row justify-content-end gap-2">
                <a href="{{ route('ppp.furniture.index') }}" class="btn btn-warning text-white shadow-sm w-100 w-sm-auto">
