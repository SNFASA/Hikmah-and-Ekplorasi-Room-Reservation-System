      ...
      <form method="post" action="{{ route('ppp.room.update', $room->no_room) }}">
        ...
        @method('PUT')     
            ...
            <div class="form-group">
                ...
                <input id="inputName" type="text" name="name" value="{{ old('name', $room->name) }}" class="form-control" required readonly>
                @error('name')
            ...
            <div class="form-group">
                ...
                <input id="capacity" type="number" name="capacity" value="{{ old('capacity', $room->capacity) }}" class="form-control" required readonly>
                @error('capacity')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="type_room" class="form-control" required readonly>
