...
@section('title', 'Electronic Equipment Edit')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Update electronic equipment details and specifications</p>
                </div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="badge bg-light text-dark px-3 py-2 rounded-pill">
                        ...
                        ID: {{ $electronics->no_electronicEquipment }}
                    </div>
                    <div class="badge bg-light text-dark px-3 py-2 rounded-pill">
        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card electronic-card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-md-end">
                            <div class="creation-info">
                                ...
                                <strong>{{ $electronics->no_electronicEquipment }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body bg-light p-4">
                    <form method="POST" action="{{ route('ppp.electronic.update', $electronics->no_electronicEquipment) }}" id="electronicEditForm">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-section mb-5 fade-in">
                            <div class="section-header mb-4">
                                ...
                                <p class="text-muted mb-0 small">Update the details for this electronic equipment</p>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input
                                            ...
                                            value="{{ old('name', $electronics->name) }}"
                                            required
                                        >
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value text-muted">{{ $electronics->name }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value text-muted">
                                                    {{ $categories->firstWhere('id', $electronics->category_id)->name ?? 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value">
                                                    <span class="badge {{ $electronics->status == 'Active' ? 'bg-success' : 'bg-danger' }} rounded-pill">
                                                        {{ $electronics->status }}
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('ppp.electronic.index') }}"
...
$(document).ready(function() {
    console.log('Electronic Equipment Edit Form initializing...');
    ...
    function updateProgress() {
        ...
        if ($('#inputTitle').val().trim()) progress++;
    ...
    console.log('Electronic Equipment Edit Form initialized successfully');
