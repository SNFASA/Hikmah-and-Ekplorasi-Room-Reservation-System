...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        ...
        <ul class="breadcrumbs mb-0">
            <li><a href="{{ route('ppp.dashboard') }}" class="text-muted">Dashboard</a></li>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    ...
                    <div class="card-body mt-5 pt-3">
                        ...
                        <p class="card-text text-muted"><i class="fas fa-user-cog"></i> {{ ucfirst($profile->role) }}</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Edit Profile Form -->
            <div class="col-md-8">
                <form class="border p-4 rounded" method="POST" action="{{ route('ppp.profile-update', $profile->id) }}">
                    @csrf
