                            ...
                            <form action="{{ route('filter.available.rooms') }}" method="POST" id="filterForm">
                                ...
                                <div class="container mt-5">
                                    ...
                                    <div class="search-box rounded-5">
                                        <div class="input-box shadow-lg rounded-5">
                                            <div class="input-group rounded-pill flex-wrap gap-2 rounded-5">
                                                <!-- Room Type -->
                                                <span class="input-group-text border-0 bg-white fw-bold">
